...
/**
 * Mutable implementation of {@link PropertyConstraintDescription}.
 * 
 ...
 */
public class MutablePropertyConstraintDescription<T> implements PropertyConstraintDescription<T> {
    ...
    public MutablePropertyConstraintDescription(String propertyName, Class<T> propertyClass) {
    ...
    public MutablePropertyConstraintDescription<T> setRequired(boolean required) {
    ...
    public MutablePropertyConstraintDescription<T> setMinimumLength(Integer minimumLength) {
    ...
    public MutablePropertyConstraintDescription<T> setMaximumLength(Integer maximumLength) {
    ...
    public MutablePropertyConstraintDescription<T> setFractionLength(Integer fractionLength) {
    ...
    public MutablePropertyConstraintDescription<T> setRadix(Integer radix) {
        this.radix = radix;
        return this;
    }
