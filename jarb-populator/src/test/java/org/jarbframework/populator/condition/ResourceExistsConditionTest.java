...
public class ResourceExistsConditionTest {

    @Test
    public void testExists() {
        Resource existingResource = new ClassPathResource("log4j.xml");
        ConditionEvaluation evaluation = new ResourceExistsCondition(existingResource).evaluate();
    ...
    public void testNonExisting() {
        ...
        ConditionEvaluation evaluation = new ResourceExistsCondition(nonExistingResource).evaluate();
