...
public class DatabaseSchemaPropertyConstraintEnhancer implements PropertyConstraintEnhancer {
    ...
    private final Logger logger = LoggerFactory.getLogger(DatabaseSchemaPropertyConstraintEnhancer.class);

    private final SchemaMapper schemaMapper;
    private final ColumnMetadataRepository columnMetadataRepository;

    public DatabaseSchemaPropertyConstraintEnhancer(SchemaMapper schemaMapper, ColumnMetadataRepository columnMetadataRepository) {
