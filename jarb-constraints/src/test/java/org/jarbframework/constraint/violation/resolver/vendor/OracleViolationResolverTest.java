...
public class OracleViolationResolverTest {
    ...
    public void testCheck() {
        DatabaseConstraintViolation violation = resolver.resolve("ORA-02290: check constraint (HIBERNATE.CK_EMPLOYEES_SALARY_MIN) violated\n");
    ...
    public void testNotNull() {
        DatabaseConstraintViolation violation = resolver.resolve("ORA-01400: cannot insert NULL into (\"HIBERNATE\".\"PROJECTS\".\"NAME\")\n");
    ...
    public void testUnique() {
        DatabaseConstraintViolation violation = resolver.resolve("ORA-00001: unique constraint (S01_PCAT3.UK_COMMODITY_GROUPS_CODE) violated\n");
    ...
    public void testForeignKey() {
        DatabaseConstraintViolation violation = resolver
                .resolve("ORA-02292: integrity constraint (S01_PCAT3.FK_COMMODITIES_COMM_GRP_ID) violated - child record found\n");
    ...
    public void testLength() {
        DatabaseConstraintViolation violation = resolver
                .resolve("ORA-12899: value too large for column \"HIBERNATE\".\"CUSTOMERS\".\"FIRST_NAME\" (actual: 72, maximum: 50)\n");
    ...
    public void testInvalidType() {
        DatabaseConstraintViolation violation = resolver.resolve("ORA-01722: invalid number\n");
