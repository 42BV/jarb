...
public class ConfigurableConstraintExceptionFactoryTest {
    ...
    public void testCustomException() {
        ...
        Throwable exception = factory.createException(builder(UNIQUE_KEY).constraint("uk_cars_license").build(), null);
    ...
    public void testDefaultException() {
        Throwable exception = factory.createException(builder(UNIQUE_KEY).constraint("uk_some_table_some_column").build(), null);
