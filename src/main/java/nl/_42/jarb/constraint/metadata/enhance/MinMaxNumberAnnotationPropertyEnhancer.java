...
public class MinMaxNumberAnnotationPropertyEnhancer implements PropertyConstraintEnhancer {
    ...
    public void enhance(PropertyConstraintDescription description) {
        ...
        if (Number.class.isAssignableFrom(javaType)) {
            Collection<javax.validation.constraints.Min> mins = Annotations.getAnnotations(description.toReference(), javax.validation.constraints.Min.class);
            Collection<javax.validation.constraints.Max> maxs = Annotations.getAnnotations(description.toReference(), javax.validation.constraints.Max.class);
